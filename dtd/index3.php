<?php
 if(isset($_POST['Emailid'])){
    ...
    if(!$con){
       ...
       $sql="INSERT INTO `food`.`3` ( `Emailid`, `password`, `Name`, `Storename`, `Address`, `Items` ) VALUES ( '$Emailid', '$password', '$Name', '$Storename', '$Address', '$Items')";
...
<head>
    ...
    <title>Ration store </title>
    <link rel="stylesheet" href="ration-storestyle.css">
</head>
<body>
    <nav class="navbar ">
        <ul class="navlist">
    ...
    <section class="boxmain background">
        <form   action="index3.php" method="post"    class="form">
